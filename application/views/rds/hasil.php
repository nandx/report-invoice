    ...
    <div class="table-responsive">
      <table id="example" class="table table-striped dt-responsive" style="font-size: 11px">
        <thead style="background-color: #EEEBDD">
          <tr>
            <th width="3%"><button onclick="document.getElementById('search_box').value = ''" type="button" name="delete_all" id="delete_all" class="btn btn-danger btn-sm"><h6 style="font-size:10px">PAID</h6></button></th>
          ...
          ?>
              <tr>
                ...
                <td>
                  ...
                  <?php } else { ?>
                    <a target="_blank" class="btn btn-sm btn-primary disabled" href="excelstandard/<?php echo $dt->ID_CHILD; ?>/<?php echo $dt->POLICYNO; ?>/<?php echo $dt->TEMP_BULAN; ?>/<?php echo $dt->TEMP_TAHUN; ?>/<?php echo $dt->IDDIVISION; ?>/<?php echo $dt->IDSUB; ?>" role="button">Lampiran</a>
                  <?php } ?>            
                </td>
